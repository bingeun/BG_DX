...
// KGCA_CharToolView.cpp : CKGCA_CharToolView 클래스의 구현
//
...
CKGCA_CharToolDoc* CKGCA_CharToolView::GetDocument() const // 디버그되지 않은 버전은 인라인으로 지정됩니다.
{
