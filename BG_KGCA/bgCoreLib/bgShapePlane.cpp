...
HRESULT bgShapePlane::Create()
{
	...
	BufferDescVertex.ByteWidth = sizeof(VertexPCT) * m_iNumVertex;
...
HRESULT bgShapePlane::Load()
{
	...
	HR_RETURN(D3DX11CompileFromFile(L"PCT_VS.hlsl", NULL, NULL, "VS", "vs_5_0", dwShaderFlags, NULL, NULL, &pVSBuf, NULL, NULL));
	HR_RETURN(m_pDevice->CreateVertexShader((DWORD*)pVSBuf->GetBufferPointer(), pVSBuf->GetBufferSize(), NULL, &m_pVertexShader));

	ID3DBlob* pPSBuf = NULL;
	HR_RETURN(D3DX11CompileFromFile(L"PCT_PS.hlsl", NULL, NULL, "PS", "ps_5_0", dwShaderFlags, NULL, NULL, &pPSBuf, NULL, NULL));
