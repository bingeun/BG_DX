...
#	include "..\protocols\box.inl"
	...
	ScripterExport Value* makeCube(Value** arg_list, int count);
	ScripterExport static Value* makeCube_ug(Value** arg_list, int count);
	ScripterExport Value* enlargeBy(Value** arg_list, int count);
	ScripterExport static Value* enlargeBy_ug(Value** arg_list, int count);
	ScripterExport Value* expandToInclude(Value** arg_list, int count);
	ScripterExport static Value* expandToInclude_ug(Value** arg_list, int count);

	// called by mxs during startup
	static void	setup();
};
