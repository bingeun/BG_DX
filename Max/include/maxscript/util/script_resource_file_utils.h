 ...
 * - A subdirectory of the directory the script file is in, where the subdirectory name
 *   is the localization name (en-US, fr-FR, ja-JP, etc.) ([scriptdir]\<lang>\[script.res])
 * - IFF script is in install tree, the localized shadow directory under the install 
 ...
 * - IFF script is in install tree, the english shadow directory under the install 
