...
//	void SetTM(Control *c);
	...
	virtual void GetClassName(MSTR& s) { s = _M("CollisionPlane"); }

	//! \brief return number of ParamBlocks in this instance
	int	NumParamBlocks() { return 1; }
	//! \brief return i'th ParamBlock
	IParamBlock2* GetParamBlock(int i) { return pblock; } // only one
	//! \brief return ParamBlock given ID
...
//access functions to the pblock
	...
	//! \brief Retrieves the name of the plugin class
	/*! \param s Reference to a string filled in with the name of the plugin class */
	virtual void GetClassName(MSTR& s) { s = _M("CollisionSphere"); }
...
//	Point3 *fnormsPrev;
	...
	//! \brief Retrieves the name of the plugin class
	/*! \param s Reference to a string filled in with the name of the plugin class */
	virtual void GetClassName(MSTR& s) { s = _M("CollisionMesh"); }
