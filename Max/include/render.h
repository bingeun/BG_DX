...
public:
	...
	RenderMode GetRenderMode() { return RM_Default; }
...
/*! This class extends the progress reporting of rendering with the ability to add high level task number and set progression through them.
*/
class RendProgressCallback2 : public RendProgressCallback {
public:
