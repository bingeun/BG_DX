...
#pragma warning( disable : 4481 )
	...
	virtual void SetElementName( MCHAR* newName ) MAX_SEALED { SetElementName(const_cast<const MCHAR*>(newName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	...
	virtual void SetFileName( MCHAR* newName) MAX_SEALED { SetFileName(const_cast<const MCHAR*>(newName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	...
	virtual void SetFileType( MCHAR* newType) MAX_SEALED { SetFileType(const_cast<const MCHAR*>(newType)); }
#pragma warning( pop )
	...
	\endcode */
	virtual	const int FindParamByName( const MCHAR* name ) = 0;
...
//
/*! \sa  Class IRenderElement , ~{ Render Elements }~\n\n
\par Description:
The system will ask a Renderer for this interface by calling
