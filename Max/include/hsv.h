...
/*! \sa  Class HSVCallback, <a href="idx__r_colorref_html.html">COLORREF - DWORD</a>, Class IPoint2.\n\n
\par Description:
...
CoreExport ColorPicker *CreateColorPicker(HWND hwndOwner, DWORD initColor,
	 IPoint2* spos, HSVCallback *pcallback, const MCHAR *name, int objClr=0);
...
/*! \sa  Class ColorPicker, Class HSVCallback, Class Class_ID, Class IPoint2, <a href="idx__r_colorref_html.html">DWORD--COLORREF Color Format</a>..\n\n
\par Description:
...
class ColPick : public InterfaceServer {
	...
	<b>DWORD *lpc</b>\n\n
	A pointer to the color to be edited. See <a href="idx__r_colorref_html.html">DWORD
	COLORREF Format</a>.\n\n
	<b>IPoint2 *spos</b>\n\n
	...
	The owning window handle.\n\n
	<b>DWORD initColor</b>\n\n
	The inital value of the color. See <a href="idx__r_colorref_html.html">DWORD COLORREF
	Format</a>.\n\n
	<b>IPoint2* spos</b>\n\n
