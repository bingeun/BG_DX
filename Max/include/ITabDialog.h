...
#define TAB_DIALOG_ENVIRONMENT_ID   Class_ID(0x447f2d77, 0x781268a7) //!< \brief Environment Dialog
#define TAB_DIALOG_CUSTOMIZE_ID     Class_ID(0x27A3F8FB, 0x8D294d77) //!< \brief Customize dialog...
//!@}
...
public:
   ...
   \param msg - See the <a href="group___tab_dialog_messages.html">list of dialog messages</a>
   \param wParam,lParam - the meaning and usage of these parameters depends on the message. 
