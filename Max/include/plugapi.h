...
#define MAX_RELEASE					MAX_RELEASE_R18 
...
#define MAX_API_NUM					MAX_API_NUM_R180 
...
/*! \deprecated There is only one product.
*/
...
CoreExport MAX_DEPRECATED APPLICATION_ID GetAppID();
//@}
...
#define	CTRL_POS_CLASS_ID		   	0x9006  //!< \deprecated Use CTRL_POSITION_CLASS_ID instead. Deprecated as of 3ds Max 2013.
#define	CTRL_QUAT_CLASS_ID			0x9007  //!< \deprecated Use CTRL_ROTATION_CLASS_ID instead. Quaternion controller super-class ID. Deprecated as of 3ds Max 2013.
...
class ClassDesc: public MaxHeapOperators {
	...
	public:
		...
		modifiers. See <a href="idx__r_list_of_super_class_ids_html.html">List of
		SuperClassIDs</a>.
		...
		*/
		...
		\param bkColor The background color. See <a href="idx__r_colorref_html.html">COLORREF-DWORD format</a>.
