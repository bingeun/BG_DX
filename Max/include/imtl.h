...
/*! \sa  Class MtlBase, Class ShadeContext, Class UVGen, Class XYZGen, Class TexHandleMaker, Class NameAccum, Class AColor, Class Matrix3, <a href="idx__r_list_of_procedural_texture_clamping_html.html">List of Procedural
