...
public:
	...
	CoreExport FPInterfaceDesc() : rollout(nullptr), action_table(nullptr), description(0L),
	flags(0), cd(nullptr), pc(nullptr){ }
	/*! \remarks Constructor.
	\par Parameters:
	<b>Interface_ID id</b>\n\n
	The unique ID of the interface.\n\n
...
public:
	...
	*/
	FPFunctionDef() : result_type(TYPE_ANGLE), ID(0) {cbStruct = sizeof(FPFunctionDef); flags = 0; description = 0; action_def = NULL; enumID = FP_NO_ENUM; keyparam_count = 0; }
...
public:
	...
	*/
	...
	CoreExport bool operator ==( const FPValue& b ) const;
};
...
public:
	...
	\par Default Implementation:
	<b>{}</b> */
	MAXException(const MCHAR* msg, int code=0) : message(msg), error_code(code) { }
};
