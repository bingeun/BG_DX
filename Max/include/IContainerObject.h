...
#define IID_CONTAINER16 Interface_ID(0xaa6f9616, 0x8275a126)
...
//!
//! \brief IContainerObject13 extends container object functionality.
...
public:
	...
	//! \param[in] anim - Animatable to be tested for support of the IContainerObject13 interface.
...
//!
//! \brief IContainerObject16 extends container object functionality.
//! In particular it provides support for control of how layer merges are handled.
class IContainerObject16  : public IContainerObject13
{
public:
//! \brief Sets whether to duplicate matching Layers without an identical parent hierarchy when merging layers.
//! \param[in] setDuplicateMatchingLayers - duplicate matching Layers without an identical parent hierarchy.
...
//! \param[in] anim - Animatable to be tested for support of the IContainerObject16 interface.
//! \return - a pointer to an IContainerObject16 interface, or NULL.
static inline IContainerObject16* GetInterface(Animatable* anim) { 
	return anim? static_cast<IContainerObject16*>(anim->GetInterface(IID_CONTAINER16)): NULL;}
};
