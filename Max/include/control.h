...
/*! \sa  Class ReferenceTarget, Class IKeyControl, Class IKDeriv, Class IKEnumCallback, Class StdControl, <a href="idx__r_list_of_controller_related_methods_html.html">List of Additional Controller Related Functions</a>, 
...
/*! \sa  Class Control, Class Interval, Class Matrix3, Class Point3,  Class Quat, Class ScaleValue, <a href="idx__r_list_of_controller_related_methods_html.html">List of Additional
...
class StdControl : public Control {
   public:     
	  ...
	  <a href="idx__r_list_of_misc_ctrl_funcs_html.html">List of Miscellaneous
