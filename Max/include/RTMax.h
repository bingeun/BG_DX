...
public:
	...
	/*! This will save the underlying shader code to the file provided. The shader code will be as a UTF8 encoded
	string without a UTF8 Byte Order Marker (BOM).
...
struct DxGeneralFunctions : public MaxHeapOperators
{
	DllExport  static const MCHAR * GetDXResourceFilename(const MCHAR * fileName);
};
