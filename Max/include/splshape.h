...
// parties or copied or duplicaype(ted in any form, in whole or in part, without
...
public:
	...
	virtual void GetClassName(MSTR& s) { s = _M("SingleRefMakerSplineNode"); } // from Animatable
};
...
public:	
	...
	RefResult NotifyRefChanged( const Interval& changeInt,RefTargetHandle hTarget, 
		PartID& partID, RefMessage message, BOOL propagate );
	virtual void GetClassName(MSTR& s) { s = _M("SingleRefMakerSplineMtl"); } // from Animatable
};
