...
/// @{
		...
		*/
		...
		<a href="idx__r_list_of_super_class_ids_html.html">List of Super Class
		IDs</a>.
		\see SClass_ID
		*/
...
/// @{
		...
		*/
		...
		See also ~{ Animatables and Sub-Animatables }~
		*/
		/// @{
...
/// @{
		...
		*/
		...
		\param gom Points to the schematic view window manager.
		\param gNode Points to this node in the schematic view.
		\return  See <a href="idx__r_colorref_html.html">COLORREF-DWORD format</a>.
		\par Default Implementation:
