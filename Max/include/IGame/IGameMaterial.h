...
public:
	...
	*/
	...
	MAX_DEPRECATED IGameFX* GetIGameFX();
...
public:
	...
	*/
	virtual const MCHAR * GetTextureClass()=0;
	...
	*/
	virtual const MCHAR * GetBitmapFileName()=0;
