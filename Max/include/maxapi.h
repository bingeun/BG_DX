...
#define XREF_TRACKS_XREF			(1<<8) //!< Controllers will not be merged, will be xrefed. It means inheriting the source controller.This status can be swited to local, but not merged.
#define XREF_TRACKS_LOCAL			(1<<9) //!< Controllers will not be merged, will be local. It means supporting locally editing and reloading.This status can be swited to xrefed, but not merged.
...
class TrackViewFilter : public InterfaceServer{
	public:
		...
		*/
		...
		<a href="idx__r_colorref_html.html">COLORREF-DWORD format</a>.
...
returned.
\par Method Groups:
See <a href="class_interface_groups.html">Method Groups for Class Interface</a>.
*/
#pragma warning(push)
#pragma warning(disable:4100)
...
//except they are used to register display selection call backs
		...
		<b>DWORD flags=0</b>\n\n
		See \ref trackViewPickDlgFlags for a list of possible flags. */
		virtual BOOL TrackViewPickMultiDlg(HWND hParent, MaxSDK::Array<TrackViewPick>* res, TrackViewFilter *filter=NULL,DWORD flags=0)=0;
		...
		*/
		 ...
		 * Sub-object selection cannot be turned on and off in 3ds Max.
		 * Calling this method has no effect on the state of sub-object selection. */
		MAX_DEPRECATED void EnableSubObjectSelection(BOOL enable);

		/** \deprecated Deprecated in 3ds Max 2015. 
		 * Sub-object selection cannot be turned of in 3ds Max, therefore this method would always return TRUE. */
		MAX_DEPRECATED BOOL IsSubObjectSelectionEnabled();
		...
		*/
		...
		<a href="idx__r_list_of_controller_related_methods_html.html">List of
	...
	// watje Gets/Sets the selection filter
		...
		*/
		...
		See <a href="idx__r_colorref_html.html">COLORREF - DWORD Color Format</a>.
		...
		*)dir)</b>\n\n
		...
		is a Checkbox labeled 'Load Plug-Ins when Used'. This method returns
		...
		/*! \remarks In the Preferences dialog / General Tab / Plug-In Loading section there
		is a Checkbox labeled 'Load Plug-Ins when Used'. This method sets the
		...
		/*! \remarks Returns one of the following values which indicates the license
		behaviour:\n\n
...
protected:
	...
	*/
	...
	//! \brief This function has been deprecated.  See IPathConfigMgr.
	virtual BOOL SetDir(int which, const MCHAR *dir) = 0;  // non-const version sealed in Interface7
	//! \brief This function has been deprecated.  See IPathConfigMgr.
	virtual MSTR GetMAXIniFile() = 0; 
	//@}
}; // Interface8
...
public:
	...
	*/
	virtual TSTR &GetCurTemplateAssetPath() = 0;
};
