...
/*! \sa  Class Mtl, Class Color, ~{ Materials, Textures and Maps }~.\n\n
\par Description:
...
class BitmapTex: public Texmap, public FPMixinInterface {
	...
	*/
	...
	virtual const MCHAR *GetMapName()=0;
...
class MultiMtl: public Mtl {
	...
	virtual void AddMtl(ReferenceTarget *rt, int mtlid, const MCHAR *name)=0;
...
/*! \sa  Class Texmap, ~{ Materials, Textures and Maps }~.\n\n
\par Description:
...
<b>void RegisterSXPReader(const MCHAR *sxpName, Class_ID cid);</b>\n\n
...
class Tex3D: public Texmap {
	...
	virtual void ReadSXPData(const MCHAR *name, void *sxpdata)=0;
	};

/*! \sa  Class Texmap, Class Color, ~{ Materials, Textures and Maps }~.\n\n
\par Description:
...
class StdCubic: public Texmap {
	...
	not. See ~{ Working With Bitmaps }~ for details on high dynamic range bitmaps.
	\par Parameters:
	<b>BOOL onoff</b>\n\n
